...
/**
 * TestingtableTable - Component for testingtable
 */
const TestingtableTable = () => {
  // State for data
  ...
  useEffect(() => {
    ...
    for (let i = 1; i <= 10; i++) {
      mockData.push({
        ...
        id: generateMockValue('BIGINT', 'id', i),
        
        tableName: generateMockValue('VARCHAR', 'tableName', i),
        
        tableType: generateMockValue('VARCHAR', 'tableType', i),
        ...
        is_delete: generateMockValue('BIT', 'is_delete', i),
        
        table_name: generateMockValue('VARCHAR', 'table_name', i),
        
        table_type: generateMockValue('VARCHAR', 'table_type', i)
    ...
    <Box sx={{ width: '100%' }}>
      ...
      >
        <DialogTitle sx={{ 
          ...
          {formMode === 'create' ? 'Add New' : 'Edit'} Testingtable
        </DialogTitle>
...
export default TestingtableTable;