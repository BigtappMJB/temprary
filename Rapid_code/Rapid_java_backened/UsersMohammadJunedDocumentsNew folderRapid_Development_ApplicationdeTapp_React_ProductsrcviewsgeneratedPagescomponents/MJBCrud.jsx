...
const apiBaseUrl = "/api/page_components";
...
try {
const response = await axios.get(`/api/page_components/all`);
setList(response.data);
} catch (error) {
console.error("Failed to fetch Page_components list:", error);
}
};
...
await axios.post(`/api/page_components/create`, submitData);
setFormData({
    id: "",
    COMPONENT_CODE: "",
});
...
console.error("Failed to save Page_components:", error);
}
};
...
try {
await axios.delete(`/api/page_components/delete/id`);
fetchList();
} catch (error) {
console.error("Failed to delete Page_components:", error);
}
};

const handleDeleteAll = async () => {
try {
await axios.delete(`/api/page_components/deleteAll`);
fetchList();
} catch (error) {
console.error("Failed to delete all Page_components:", error);
}
};
...
<ContainerCard>
            ...
            <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} md={4}>
                            <FormControl fullWidth margin="normal">
                                <InputLabel>COMPONENT_CODE</InputLabel>
                                <Select
                                        name="COMPONENT_CODE"
    ...
    <Table>
        <TableHead>
            <TableRow>
                        <TableHeaderCell>COMPONENT_CODE</TableHeaderCell>
...
export default Page_componentsCrud;
