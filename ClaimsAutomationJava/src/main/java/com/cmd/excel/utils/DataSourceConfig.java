...
//	@Value("${csv.gen.cron.expression1}")
//	private String expression1;
//	
//	@Value("${csv.gen.cron.expression2}")
//	private String expression2;
	...
	public Connection getDBConnection() throws SQLException {
		String url = "jdbc:mysql://13.201.216.64:3306/cmd?useSSL=false";
...
//	@Bean
//	public void defaultSchedular() {
//		try {
//			schedulerService.scheduleFirstJob(expression1);
//			schedulerService.scheduleSecondJob(expression2);
//		} catch (Exception e) {
