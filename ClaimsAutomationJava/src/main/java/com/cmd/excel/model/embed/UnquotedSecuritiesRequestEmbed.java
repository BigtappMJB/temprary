...
public class UnquotedSecuritiesRequestEmbed implements Serializable{

	private static final long serialVersionUID = 1L;
	private String  primaryAssetId;
	private String primaryAssetIdType;
	
	public  UnquotedSecuritiesRequestEmbed() {
		super();
	}

	public  UnquotedSecuritiesRequestEmbed(String  primaryAssetId, String primaryAssetIdType) {
		super();
