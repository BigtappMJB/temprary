...
public class CashSecuritiesRequestEmbed  implements Serializable {
	private static final long serialVersionUID = 1L;
	private String  primaryAssetId;
	private String primaryAssetIdType;
	
	public CashSecuritiesRequestEmbed() {
		super();
	}

	public  CashSecuritiesRequestEmbed(String  primaryAssetId, String primaryAssetIdType) {
		super();
