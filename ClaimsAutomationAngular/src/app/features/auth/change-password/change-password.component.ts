...
export class ChangePasswordComponent implements OnInit {
  ...
  clkChangePassword() {
    ...
    if (this.loginData.isDefaultPasswordChanged == null) {
      ...
      this.changepasswordService.changeDefaultPassword(requestBody).subscribe(res => {
        this.ChangePasswordForm.reset();
        if (res.message=="Password updated successfully") {

          this.headerService.UserChangePasswordLogout(this.loginData.userId).subscribe((response) => {
            this.dataStorageService.isUserLoggedIn = true;
      ...
      this.changepasswordService.changepassword(requestBody).subscribe(res => {
        this.ChangePasswordForm.reset();
