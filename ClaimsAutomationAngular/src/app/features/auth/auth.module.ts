...
import { RegisterationService } from './registeration/service/registeration.service';
...
@NgModule({
  ...
  providers: [LoginService, ChangePasswordService, RegisterationService, EmailVerificationService, ForgetPasswordService]
})
