...
public class LoginController {
	...
	public ResponseEntity<?> login(@RequestBody Map<String, String> data)
		...
		if (user == null) {
			...
			return ResponseEntity.status(HttpStatus.NOT_FOUND)
					.body(Collections.singletonMap("error", "User not found. Please check your email and try again."));
		}
		...
		if (!storedPassword.equals(providedPassword)) {
			...
			return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(Collections.singletonMap("error",
	...
	public ResponseEntity<?> getUserPermissionsByEmail(@RequestBody Map<String, String> data)
			throws SQLException, JsonMappingException, JsonProcessingException {
		String email = data.get("email");
	...
	@PostMapping("/enrollPassword")
	public ResponseEntity<String> enrollPassword(@RequestBody String data_j, @RequestParam int id) throws SQLException {
		return (ResponseEntity<String>) registerRepository.updatePassword(data_j, id);
	}
