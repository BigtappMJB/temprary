...
import com.example.auto.entity.PermissionModel;
...
public class RoleController {
 ...
 public ResponseEntity<Object> updateRole(@PathVariable int id, @RequestBody Map<String, String> data) throws SQLException {
     String name = data.get("name");
     String description = data.get("description");
